...
//		string pdbFile = "1kx2";
//		UnityMolStructure s =  UnityMolPDBParser.LoadPDB(pathTestData + "/"+ pdbFile);
//		Debug.Log(s.Models[0].AllAtoms[1]);
//		Debug.Log(s.Models[0].AllAtoms[1].Type);
	...
	public void SizeResidueTest() {
		res = new UnityMolResidue(1, list_atoms, "DUMMY");
